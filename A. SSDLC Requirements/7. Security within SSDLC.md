...
# Security within Change Management & Agile Development
...
# Security of 3rd party dependencies in target production environment:
...
# Security approvals (security gates)
