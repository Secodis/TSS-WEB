...
1. **Track Security Defects:** Security defects MUST be tracked in a defect tracking system with relevant Metadata (e.g. SLA, source, criticality, CVSS score, etc).
