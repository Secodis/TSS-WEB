...
1. **Track Security Defects:** Security defects SHOULD be tracked in a defect tracking system with relevant metadata (e.g. SLA, source, criticality, CVSS score, etc).
