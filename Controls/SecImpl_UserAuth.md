...
3. Usernames SHOULD be personalized.
4. In case a user login fails, the application MUST NOT disclose information on the cause of the error (e.g. “*Your password is wrong.*”). Positive example: “*Username or password was incorrect.*”.
5. Autocomplete for all fields on login dialogs SHOULD be deactivated by using the following statement `autocomplete="off"`.
