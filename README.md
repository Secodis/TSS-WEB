...
Additional notable standards in this field include the [BSA Framework for Secure Software (UK)](https://www.bsa.org/reports/updated-bsa-framework-for-secure-software) and [BSI TR-03185 Sicherer Software-Lebenszyklus (DE}](https://www.bsi.bund.de/DE/Themen/Unternehmen-und-Organisationen/Standards-und-Zertifizierung/Technische-Richtlinien/TR-nach-Thema-sortiert/tr03185/TR-03185_node.html). Additionally, you may want to explore [OpenCRE](https://www.opencre.org/), which provides a comprehensive mapping of ApPSec requirements across a a wide range of standards.
