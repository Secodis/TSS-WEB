...
| [NIST SSDF](https://csrc.nist.gov/Projects/ssdf)  | The SSDF has a different focus and primarily adresses pretty rigid security requirements for software vendors of public institutionsin the US. TSS-WEB still covers many requirements, especially from doma8ns Protect Software (PS) and Produce Well-Secured Software (PW), but with a different focus. |
