...
| Environment Management | Stream A Configuration Hardening | 1 | Perform best-effort hardening of configurations, based on readily available information. | Yes. See  [{{site.TITLE_SSDLC_SECOP_HARDENING}}]({{site.TITLE_SSDLC_SECOP_HARDENING}})] |
...
| Environment Management | Stream A Configuration Hardening | 3 | Actively monitor configurations for non-conformance to baselines, and handle detected occurrences as security defects. | Yes. See [{{site.TITLE_SSDLC_SECOP_HARDENING}}]({{site.TITLE_SSDLC_SECOP_HARDENING}})] |
...
| Operational Management | Stream A Data Protection | 2 | Develop data catalog and establish data protection policy. | Yes. See [{{site.TITLE_SSDLC_SECDEV_SECDOCU}}]({{site.URL_SSDLC_SECDEV_SECDOCU}}) |
