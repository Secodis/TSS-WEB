...
| Education & Guidance | Stream A Training and Awareness | 2 | Offer technology and role-specific guidance, including security nuances of each language and platform | Yes. See “General Requirements” at [{{site.TITLE_SSDLC_SECDEV_ROLES}}]({{site.URL_SSDLC_SECDEV_ROLES}}) |
...
| Education & Guidance |Stream A Training and Awareness | 1 | Identify a “Security Champion” within each development team. | Yes. See “General Requirements” at [{{site.TITLE_SSDLC_SECDEV_ROLES}}]({{site.URL_SSDLC_SECDEV_ROLES}}) |
...
| Security Practices | Stream | Mat. Level | Requirement | TSS-WEB Coverage |
| ------------- | ------------- | ------------- | ------------- | ------------- |
| Threat Assessment | Stream A Application Risk Profile | 1 | A basic assessment of the application risk is performed to understand likelihood and impact of an attack. | Yes. See “Security within change management & agile development” at [{{site.TITLE_SSDLC_SECDEV_AGILESEC}}]({{site.URL_SSDLC_SECDEV_AGILESEC}}) |
...
| Threat Assessment | Stream B Threat Modeling | 1 | Perform best-effort, risk-based threat modeling using brainstorming and existing diagrams with simple threat checklists. | See “Security within change management & agile development” at [{{site.TITLE_SSDLC_SECDEV_AGILESEC}}]({{site.URL_SSDLC_SECDEV_AGILESEC}}) and [{{site.TITLE_SSDLC_SECDEV_SECDESIGN}}]({{site.URL_SSDLC_SECDEV_SECDESIGN}}).
...
| Security Requirements | Stream A Software Requirements | 2 | Structured security requirements are available and utilized by developer teams. | Yes. See [{{site.TITLE_SSDLC_SECDEV_SECIMP}}]({{site.TITLE_SSDLC_SECDEV_SECIMP}}). |
| Security Requirements | Stream A Software Requirements | 3 | Build a requirements framework for product teams to utilize. | Yes. See [{{site.TITLE_SSDLC_SECDEV_SECIMP}}]({{site.TITLE_SSDLC_SECDEV_SECIMP}}). |
...
| Requirements-driven Testing | Stream B Misuse / Abuse Testing | 3 |  Denial of service and security stress testing | Yes. See  at [{{site.TITLE_SSDLC_SECTESTS_CUSTOMTESTS}}]({{site.URL_SSDLC_SECTESTS_CUSTOMTESTS}}). |
...
| Security Testing | Stream B Deep Understanding | 3 | Integrate security testing into development process  | Yes. See See  [{{site.TITLE_SSDLC_SECTESTS_CUSTOMTESTS}}]({{site.URL_SSDLC_SECTESTS_CUSTOMTESTS}}). |
